...
public class GRDiscussionTask3 : MonoBehaviour
{
    ...
    public Text statement1, statement2, statement3, statement4, statement5, statement6, statement7, statement8, statement9, statement10;
