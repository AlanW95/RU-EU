...
public class GRFinalAssignment : MonoBehaviour
{
    ...
    public Text interview101, interview102, interview103;//, interview104;
    public Text interview201, interview202, interview203;//, interview204;
    public Text discussion1, discussion2, discussion3, discussion4;
    ...
    public Text introduction;//, paragraph1, paragraph2;
    ...
    void Update()
    {
        ...
        introduction.text = "Τα κύρια ζητήματα που απασχολούν τους πολίτες της ΕΕ φαίνεται να είναι: " + theme1 + " and " + theme2 + ". Now select 4 views that you think best illustrate your views about Brexit.";
