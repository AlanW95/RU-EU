...
public class GRNewsflash : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        headlineText.text = "Κανείς δεν είχε προβλέψει τα προβλήματα που θα προκαλούσαν τα Ιρλανδικά σύνορα για το Brexit.";
    }
    ...
    public void Statement2() {
        headlineText.text = "Τα χωριστά κυρίαρχα έθνη του παρελθόντος δεν μπορούν να λύσουν τα προβλήματα του παρόντος. Πρέπει να προχωρήσουμε μαζί στην Ευρώπη.";
    ...
    public void Statement3() {
        headlineText.text = "Οι περισσότεροι πολίτες της ΕΕ έχουν μεγαλύτερη επίγνωση για τον πολιτισμό της χώρας τους από ότι για τον ευρωπαϊκό πολιτισμό  γενικότερα.";
    ...
    public void Statement4() {
        headlineText.text = "Οι νέοι ανησυχούν πολύ για τα περιβαλλοντικά ζητήματα.";
    ...
    public void Statement5() {
        headlineText.text = "Οι ευρωπαϊκοί νόμοι δεν μπορούν ποτέ να είναι δίκαιοι για όλους.";
    ...
    public void Statement6() {
        headlineText.text = "Η έξοδος από την ΕΕ θα επιτρέψει στο Ηνωμένο Βασίλειο να επιτύχει εμπορικές συμφωνίες με τον υπόλοιπο κόσμο.";
