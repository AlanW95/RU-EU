...
public class FinalAssignmentNL : MonoBehaviour
{
    ...
    void Update() {
        interview101.text = PlayerPrefs.GetString("LorryTruckInterview1-1");
        interview102.text = PlayerPrefs.GetString("LorryTruckInterview1-2");
        interview103.text = PlayerPrefs.GetString("LorryTruckInterview1-3");

        interview201.text = PlayerPrefs.GetString("LorryTruckInterview2-1");
        interview202.text = PlayerPrefs.GetString("LorryTruckInterview2-2");
        interview203.text = PlayerPrefs.GetString("LorryTruckInterview2-3");

        discussion1.text = PlayerPrefs.GetString("NewLorryTruckDiscussion1");
        discussion2.text = PlayerPrefs.GetString("NewLorryTruckDiscussion2");
        discussion3.text = PlayerPrefs.GetString("NewLorryTruckDiscussion3");
        discussion4.text = PlayerPrefs.GetString("NewLorryTruckDiscussion4");

        theme1 = PlayerPrefs.GetString("TopLorryTruckTheme");
        theme2 = PlayerPrefs.GetString("SecondLorryTruckTheme");
        introduction.text = "The top 2 issues that concern EU citizens are; " + theme1 + " and " + theme2 + ". Now select 4 views that you think best illustrate your views about lorry truck driver issues.";
