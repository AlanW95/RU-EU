...
public class PreFANL : MonoBehaviour
{
    ...
    [SerializeField]
    private string BASE_URL = "https://docs.google.com/forms/u/0/d/e/1FAIpQLSfpV8tSXz6KmVBleG_ZqSgImi9w5NRqUBUX8OA7CY3MpAgD9g/formResponse";
    ...
    IEnumerator Post(string emailAnswer, string pro1, string pro2, string pro3, string anti1, string anti2, string anti3) {
        ...
        form.AddField("entry.1973425606", emailAnswer);
        form.AddField("entry.2140088696", pro1);
        form.AddField("entry.1421580968", pro2);
        form.AddField("entry.1389877100", pro3);
        form.AddField("entry.57047394", anti1);
        form.AddField("entry.1636494362", anti2);
        form.AddField("entry.1515730962", anti3);
