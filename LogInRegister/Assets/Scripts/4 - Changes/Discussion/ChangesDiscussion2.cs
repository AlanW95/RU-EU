...
public class ChangesDiscussion2 : MonoBehaviour
{
    ...
    void Start() {
        ...
        statement1.text = PlayerPrefs.GetString("ChangesDiscussion1");
        statement2.text = PlayerPrefs.GetString("ChangesDiscussion2");
        statement3.text = PlayerPrefs.GetString("ChangesDiscussion3");
        statement4.text = PlayerPrefs.GetString("ChangesDiscussion4");
        statement5.text = PlayerPrefs.GetString("ChangesDiscussion5");
    ...
    void Update() {
        ...
        if (task3Counter == 2) {
            ...
            statement6.text = PlayerPrefs.GetString("ChangesDiscussion6");
            statement7.text = PlayerPrefs.GetString("ChangesDiscussion7");
            statement8.text = PlayerPrefs.GetString("ChangesDiscussion8");
            statement9.text = PlayerPrefs.GetString("ChangesDiscussion9");
            statement10.text = PlayerPrefs.GetString("ChangesDiscussion10");
        }
    ...
    public void Statement1Selected() {
        ...
        if (predictorCounter == 3) {
            ...
            PlayerPrefs.SetString("NewChangesDiscussion1", statement1.text);
        }

        if (predictorCounter == 2) {
            //add to new PlayerPrefs
            PlayerPrefs.SetString("NewChangesDiscussion2", statement1.text);
        }
    }
    ...
    public void Statement2Selected() {
        ...
        if (predictorCounter == 3) {
            //add to new PlayerPrefs
            PlayerPrefs.SetString("NewChangesDiscussion1", statement2.text);
        }

        if (predictorCounter == 2) {
            //add to new PlayerPrefs
            PlayerPrefs.SetString("NewChangesDiscussion2", statement2.text);
        }
    }
    ...
    public void Statement3() {
        ...
        if (predictorCounter == 3) {
            //add to new PlayerPrefs
            PlayerPrefs.SetString("NewChangesDiscussion1", statement3.text);
        }

        if (predictorCounter == 2) {
            //add to new PlayerPrefs
            PlayerPrefs.SetString("NewChangesDiscussion2", statement3.text);
        }
    }
    ...
    public void Statement4Selected() {
        ...
        if (predictorCounter == 3) {
            //add to new PlayerPrefs
            PlayerPrefs.SetString("NewChangesDiscussion1", statement4.text);
        }

        if (predictorCounter == 2) {
            //add to new PlayerPrefs
            PlayerPrefs.SetString("NewChangesDiscussion2", statement4.text);
        }
    }
    ...
    public void Statement5Selected() {
        ...
        if (predictorCounter == 3) {
            //add to new PlayerPrefs
            PlayerPrefs.SetString("NewChangesDiscussion1", statement5.text);
        }

        if (predictorCounter == 2) {
            //add to new PlayerPrefs
            PlayerPrefs.SetString("NewChangesDiscussion2", statement5.text);
        }
    }
    ...
    public void Statement6Selected() {
        ...
        if (predictorCounter == 1) {
            //add to new PlayerPrefs
            PlayerPrefs.SetString("NewChangesDiscussion3", statement6.text);
        }

        if (predictorCounter == 0) {
            //add to new PlayerPrefs
            PlayerPrefs.SetString("NewChangesDiscussion4", statement6.text);
        }
    }
    ...
    public void Statement7Selected() {
        ...
        if (predictorCounter == 1) {
            //add to new PlayerPrefs
            PlayerPrefs.SetString("NewChangesDiscussion3", statement7.text);
        }

        if (predictorCounter == 0) {
            //add to new PlayerPrefs
            PlayerPrefs.SetString("NewChangesDiscussion4", statement7.text);
        }
    }
    ...
    public void Statement8Selected() {
        ...
        if (predictorCounter == 1) {
            //add to new PlayerPrefs
            PlayerPrefs.SetString("NewChangesDiscussion3", statement8.text);
        }

        if (predictorCounter == 0) {
            //add to new PlayerPrefs
            PlayerPrefs.SetString("NewChangesDiscussion4", statement8.text);
        }
    }
    ...
    public void Statement9Selected() {
        ...
        if (predictorCounter == 1) {
            //add to new PlayerPrefs
            PlayerPrefs.SetString("NewChangesDiscussion3", statement9.text);
        }

        if (predictorCounter == 0) {
            //add to new PlayerPrefs
            PlayerPrefs.SetString("NewChangesDiscussion4", statement9.text);
        }
    }
    ...
    public void Statement10Selected() {
        ...
        if (predictorCounter == 1) {
            //add to new PlayerPrefs
            PlayerPrefs.SetString("NewChangesDiscussion3", statement10.text);
        }

        if (predictorCounter == 0) {
            //add to new PlayerPrefs
            PlayerPrefs.SetString("NewChangesDiscussion4", statement10.text);
        }
    }
}
