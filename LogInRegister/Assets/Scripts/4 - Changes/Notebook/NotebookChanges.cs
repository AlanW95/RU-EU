...
public class NotebookChanges : MonoBehaviour
{
    ...
    void Update() {
        ...
        //Interview 1
        interview1TextDisplay1.text = PlayerPrefs.GetString("ChangesInterview1-1");
        interview1TextDisplay2.text = PlayerPrefs.GetString("ChangesInterview1-2");
        interview1TextDisplay3.text = PlayerPrefs.GetString("ChangesInterview1-3");
        interview1TextDisplay4.text = PlayerPrefs.GetString("ChangesInterview1-4");

        //Interview 2
        interview2TextDisplay[0].text = PlayerPrefs.GetString("ChangesInterview2-1");
        interview2TextDisplay[1].text = PlayerPrefs.GetString("ChangesInterview2-2");
        interview2TextDisplay[2].text = PlayerPrefs.GetString("ChangesInterview2-3");
        interview2TextDisplay[3].text = PlayerPrefs.GetString("ChangesInterview2-4");

        //Balance Scenario
        discussionTextDisplay1.text = PlayerPrefs.GetString("NewChangesDiscussion1");
        discussionTextDisplay2.text = PlayerPrefs.GetString("NewChangesDiscussion2");
        discussionTextDisplay3.text = PlayerPrefs.GetString("NewChangesDiscussion3");
        discussionTextDisplay4.text = PlayerPrefs.GetString("NewChangesDiscussion4");
