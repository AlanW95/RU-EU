...
public class FinalAssignmentImmigration : MonoBehaviour
{
    ...
    void Update() {
        interview101.text = PlayerPrefs.GetString("ImmigrationProInterview1");
        interview102.text = PlayerPrefs.GetString("ImmigrationProInterview2");
        interview103.text = PlayerPrefs.GetString("ImmigrationProInterview3");

        interview201.text = PlayerPrefs.GetString("ImmigrationAntiInterview1");
        interview202.text = PlayerPrefs.GetString("ImmigrationAntiInterview2");
        interview203.text = PlayerPrefs.GetString("ImmigrationAntiInterview3");

        discussion1.text = PlayerPrefs.GetString("NewImmigrationDiscussion1");
        discussion2.text = PlayerPrefs.GetString("NewImmigrationDiscussion2");
        discussion3.text = PlayerPrefs.GetString("NewImmigrationDiscussion3");
        discussion4.text = PlayerPrefs.GetString("NewImmigrationDiscussion4");

        theme1 = PlayerPrefs.GetString("TopImmigrationTheme");
        theme2 = PlayerPrefs.GetString("SecondImmigrationTheme");
        introduction.text = "The top 2 issues that concern EU citizens are; " + theme1 + " and " + theme2 + ". Now select 4 views that you think best illustrate your views about Immigration.";
