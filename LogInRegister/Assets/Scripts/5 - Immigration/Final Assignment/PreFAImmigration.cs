...
public class PreFAImmigration : MonoBehaviour
{
    ...
    [SerializeField]
    private string BASE_URL = "https://docs.google.com/forms/u/0/d/e/1FAIpQLSfqkJlUlw2iAn7CFY4Q_4V_661TvRf_75jGaYLSr48J150H9g/formResponse";
    ...
    IEnumerator Post(string emailAnswer, string pro1, string pro2, string pro3, string anti1, string anti2, string anti3) {
        ...
        form.AddField("entry.690176539", emailAnswer);
        form.AddField("entry.808734111", pro1);
        form.AddField("entry.923331502", pro2);
        form.AddField("entry.379993426", pro3);
        form.AddField("entry.673511785", anti1);
        form.AddField("entry.1997586148", anti2);
        form.AddField("entry.581849704", anti3);
